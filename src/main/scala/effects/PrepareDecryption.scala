...
object PrepareDecryption extends CryptoCompanion[PrepareDecryption]:
  ...
  def fromString[T](charSet: String)(deserialize: String => T): PrepareDecryption[T] = new:
  ...
  def fromBytes[T](charSet: String)(deserialize: Array[Byte] => T): PrepareDecryption[T] = new:
    override val charset: String = charSet
